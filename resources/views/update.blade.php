                ...
                <div class="max-w-md mx-auto">
                    ...
                    <div class="flex items-center space-x-5">
                        ...
                        <div class="block pl-2 font-semibold text-xl self-start text-gray-700">
                            <h2 class="leading-relaxed">UPDATE DATA ACARA</h2>
                            <p class="text-sm text-gray-500 font-normal leading-relaxed">
                                PT. Acara Maju Bersama
                            </p>
                        </div>
                    </div>
                    <form method="POST" action="{{ route('event.update', $event->id) }}" method="POST">
                        @csrf
                        {{ method_field('PUT') }}
                            ...
                            <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <div class="relative focus-within:text-gray-600 text-gray-400">
                                            <input type="text" name="tgl_mulai"
                                                ...
                                                placeholder="2021/12/31" value="{{ $event->start_event }}" />
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <div class="relative focus-within:text-gray-600 text-gray-400">
                                            <input type="text" name="tgl_akhir"
                                                class="pr-4 pl-10 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
                                                placeholder="2021/12/31" value="{{ $event->finish_event }}" />
                                            <div class="absolute left-3 top-2">
                                                <svg class="w-6 h-6" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <input type="text" name="desc_acara"
                                        class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
                                        placeholder="Optional" value="{{ $event->event_desc }}" />
                                </div>
                            </div>
